...
extern void registerBridgeCallback(FlutterBridge callback);
extern void startPocketbase(char* path, char* port, char* hostname, GoUint8 getApiLogs);
extern void stopPocketbase();
